      ...
      <div className="border rounded-lg shadow-inner h-[70vh] overflow-y-scroll p-6 bg-white text-gray-900">
        <div className="prose prose-lg max-w-none space-y-4">
          ...
          <p>
            ...
            We use, or the information We collect using Cookies and how that information
            is used. This Cookies Policy has been created with the help of the{" "}
          ...
          <ul className="ml-6">
            <li>
              <strong>Company</strong> refers to ByteMe, Exeter.
            </li>
            <li>
          ...
          <p>
            Where required by law, We will request your consent before using Cookies
            that are not strictly necessary. Strictly necessary Cookies are used to provide
          ...
          <p>
            ...
            in your browser associated with the Website. You may use this option for preventing
          ...
          <ul className="ml-6">
            <li>
              <a href="https://support.google.com/accounts/answer/32050" target="_blank">Chrome</a>
            </li>
            <li>
              <a href="https://support.microsoft.com/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank">Microsoft Edge</a>
            </li>
            <li>
              <a href="https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored" target="_blank">Firefox</a>
            </li>
            <li>
              <a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" target="_blank">Safari</a>
            </li>
          </ul>
