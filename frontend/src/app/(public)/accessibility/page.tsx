    ...
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="border rounded-lg shadow-inner h-[70vh] overflow-y-scroll p-6 bg-white">
        <div className="prose prose-lg max-w-none space-y-4">
          <h2>Accessibility Statement for <span class="basic-information website-name">ByteMe</span></h2>
          <p>
            This is an accessibility statement from <span class="basic-information organization-name">ByteMe</span>.
          </p>
          <h3>Measures to support accessibility</h3>
          <p>
            <span class="basic-information organization-name">ByteMe</span>
            takes the following measures to ensure accessibility of
            <span class="basic-information website-name">ByteMe</span>:
          </p>
          ...
          <ul class="basic-information feedback h-card">
            <li class="contact-other p-note">At our website: <a href="https://frontend-production-c253c.up.railway.app/support">https://frontend-production-c253c.up.railway.app/support</a></li>
          </ul>
          ...
          <p>
            ...
            <span class="basic-information website-name">ByteMe</span> , there may be some limitations. Below is a description of known limitations, and potential solutions. Please contact us if you observe an issue not listed below.
          </p>
          <p>
          ...
          <p class="complaints">We plan to implement issue forums in the next iteration of this website</p>
        </div>
      </div>
    </main>
  );
